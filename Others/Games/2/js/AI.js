...
AI.init = function(pace){
	...
	if (val&&val.value!=-8888) {
		...
		com.get("moveInfo").innerHTML='<h3>AI search results:</h3>Best view'+
										com.createMove(com.arr2Clone(play.map),man.x,man.y,val.x,val.y)+
										'<br />Search depth'+AI.treeDepth+'<br />Search for branches'+
										AI.number+'piece <br />Best-in-class assessment:'+
										val.value+'minute(s)'+
										' <br />Search time'+
										(nowTime-initTime)+'millisecond'
